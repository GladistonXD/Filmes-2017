...
ClistaGO0=["todos",                                                  "acao",                             "acao/page/2/",                         "acao/page/3/",                           "acao/page/4/",                      "acao/page/5/",                           "animacao",                              "Animacao/page/2/",                         "aventura",                              "aventura/page/2/",                           "aventura/page/3/",                             "comedia",                  "comedia/page/2/",                            "comedia/page/3/",                            "comedia/page/4/", "drama", "fantasia", "ficcao-cientifica","faroeste","romance",                            "suspense",                               "suspense/page/2/",                         "suspense/page/3/",                                    "terror"]
ClistaGO1=["[COLOR yellow][B]Mostrar Todos[/COLOR][/B]",            "[COLOR red][B]Ação 1[/COLOR][/B]","[COLOR red][B]Ação 2[/COLOR][/B]",      "[COLOR red][B]Ação 3[/COLOR][/B]",       "[COLOR red][B]Ação 4[/COLOR][/B]",  "[COLOR red][B]Ação 5[/COLOR][/B]",       "[COLOR lime][B]Animação 1[/COLOR][/B]","[COLOR lime][B]Animação 2[/COLOR][/B]",     "[COLOR cyan][B]Aventura 1[/COLOR][/B]","[COLOR cyan][B]Aventura 2[/COLOR][/B]",       "[COLOR cyan][B]Aventura 3[/COLOR][/B]",       "[COLOR hotpink][B]Comédia 1[/COLOR][/B]","[COLOR hotpink][B]Comédia 2[/COLOR][/B]",      "[COLOR hotpink][B]Comédia 3[/COLOR][/B]",      "[COLOR hotpink][B]Comédia 4[/COLOR][/B]",       "[COLOR springgreen][B]Drama[/COLOR][/B]", "[COLOR salmon][B]Fantasia[/COLOR][/B]", "[COLOR paleturquoise][B]Ficção-Científica[/COLOR][/B]","[COLOR darkorange][B]Faroeste[/COLOR][/B]","[COLOR deepskyblue][B]Romance[/COLOR][/B]", "[COLOR darkorchid][B]Suspense 1[/COLOR][/B]","[COLOR darkorchid][B]Suspense 2[/COLOR][/B]","[COLOR darkorchid][B]Suspense 3[/COLOR][/B]",             "[COLOR lightgreen][B]Terror[/COLOR][/B]"]
...
def MFilmes(): #-2
	...
	AddDir("[B][COLOR cyan]Filmes Lançamentos MMFilmes[/COLOR][/B]", "config" , 184,"https://walter.trakt.tv/images/movies/000/191/797/fanarts/thumb/6049212229.jpg", "https://walter.trakt.tv/images/movies/000/191/797/fanarts/thumb/6049212229.jpg", isFolder=True)
	AddDir("[B][COLOR cyan]Filmes MMFilmes[/COLOR][/B]", "config" , 180,"https://uploaddeimagens.com.br/images/002/376/272/original/TONY.jpg", "https://uploaddeimagens.com.br/images/002/376/272/original/TONY.jpg", isFolder=True)
	...
	AddDir("[COLOR yellow][B]Filmes NetCine[/B][/COLOR]" , "", 71, "https://uploaddeimagens.com.br/images/002/376/273/original/THORR.jpg", "https://uploaddeimagens.com.br/images/002/376/273/original/THORR.jpg")
	...
	AddDir("[COLOR blue][B]Filmes Dublado RedeCanais[/B][/COLOR]" , cPage, 90, "https://uploaddeimagens.com.br/images/002/376/274/original/ROCKKAAS.jpg", "https://uploaddeimagens.com.br/images/002/376/274/original/ROCKKAAS.jpg", background="cPage")
...
def MSeries(): #-3
	...
	AddDir("[B][COLOR cyan]Séries MMFilmes[/COLOR][/B]", "config" , 190,"https://walter.trakt.tv/images/shows/000/037/522/fanarts/thumb/6ecdb75c1c.jpg", "https://walter.trakt.tv/images/shows/000/037/522/fanarts/thumb/6ecdb75c1c.jpg", isFolder=True)
	setViewM()
# --------------  Fim menu
# --------------  Inicio Filme CB
def Filmes96(): #220
...
def Series(): #60
	try:
		...
		lista = re.compile("img src\=\"([^\"]+).+?alt\=\"([^\"]+).+?f\=\"([^\"]+)").findall(l2[0]+l3[0]+l4[0])
		if cOrdNCS=="1":
...
# --------------------------------------
def MoviesNC(): #71
	AddDir("[COLOR yellow][B][Genero dos Filmes]:[/B] " + ClistaGO1[int(CatGO)] +"[/COLOR]", "url" ,219 ,"https://lh5.ggpht.com/gv992ET6R_InCoMXXwIbdRLJczqOHFfLxIeY-bN2nFq0r8MDe-y-cF2aWq6Qy9P_K-4=w300", "https://lh5.ggpht.com/gv992ET6R_InCoMXXwIbdRLJczqOHFfLxIeY-bN2nFq0r8MDe-y-cF2aWq6Qy9P_K-4=w300", isFolder=False)
	...
	try:
		if CatGO=="0":
			...
			link = common.OpenURL("http://netcine.me/page/6/?mt").replace('\n','').replace('\r','')
			l6 = re.compile("box_movies(.+)").findall(link)
			link = common.OpenURL("http://netcine.me/page/7/?mt").replace('\n','').replace('\r','')
			l7 = re.compile("box_movies(.+)").findall(link)
			link = common.OpenURL("http://netcine.me/page/8/?mt").replace('\n','').replace('\r','')
			l8 = re.compile("box_movies(.+)").findall(link)
			link = common.OpenURL("http://netcine.me/page/9/?mt").replace('\n','').replace('\r','')
			l9 = re.compile("box_movies(.+)").findall(link)
			link = common.OpenURL("http://netcine.me/page/10/?mt").replace('\n','').replace('\r','')
			l10 = re.compile("box_movies(.+)").findall(link)
			link = common.OpenURL("http://netcine.me/page/11/?mt").replace('\n','').replace('\r','')
			l11 = re.compile("box_movies(.+)").findall(link)
			link = common.OpenURL("http://netcine.me/page/12/?mt").replace('\n','').replace('\r','')
			l12 = re.compile("box_movies(.+)").findall(link)
			link = common.OpenURL("http://netcine.me/page/13/?mt").replace('\n','').replace('\r','')
			l13 = re.compile("box_movies(.+)").findall(link)
			link = common.OpenURL("http://netcine.me/page/14/?mt").replace('\n','').replace('\r','')
			lista = re.compile("img src\=\"([^\"]+).+?alt\=\"([^\"]+).+?f\=\"([^\"]+)").findall(l1[0]+l2[0]+l3[0]+l4[0]+l5[0]+l6[0]+l7[0]+l8[0]+l9[0]+l10[0]+l11[0]+l12[0]+l13[0])
		else:
			link = common.OpenURL("http://netcine.me/category/"+ClistaGO0[int(CatGO)]).replace('\n','').replace('\r','')
			l2 = re.compile("box_movies(.+)").findall(link)
...
def MoviesRCL(): #91 Filme Legendado
	...
	try:
		...
		for x in range(0, 5):
			l +=1
			link = common.OpenURL(proxy+"https://www."+RC+"browse-filmes-legendado-videos-"+str(l)+"-"+cOrdRCF+".html")
			if Clista2[int(Cat)] != "Sem filtro (Mostrar Todos)":
				link = common.OpenURL(proxy+"https://www."+RC+"browse-"+Clista2[int(Cat)]+"-Filmes-Legendado-videos-"+str(l)+"-"+cOrdRCF+".html")
			match = re.compile('href=\"([^\"]+).{0,10}title=\"([^\"]+)\".{20,350}echo=\"([^\"]+)').findall(link.replace('\n','').replace('\r',''))
			if match:
				for url2,name2,img2 in match:
					url2 = re.sub('^\.', "https://www."+RC+"", url2 )
...
def MoviesRCN(): #92 Filmes Nacional
	...
	try:
		...
		for x in range(0, 5):
			l +=1
			link = common.OpenURL(proxy+"https://www."+RC+"browse-filmes-nacional-videos-"+str(l)+"-"+cOrdRCF+".html")
			match = re.compile('href=\"([^\"]+).{0,10}title=\"([^\"]+)\".{20,350}echo=\"([^\"]+)').findall(link.replace('\n','').replace('\r',''))
			if match:
				for url2,name2,img2 in match:
					url2 = re.sub('^\.', "https://www."+RC, url2 )
...
def MoviesRCR(): # Lancamentos
	...
	try:
		...
		for x in range(0, 5):
			l +=1
			link = common.OpenURL(proxy+"https://www."+RC+"browse-filmes-lancamentos-videos-"+str(l)+"-date.html")
			match = re.compile('href=\"([^\"]+).{0,10}title=\"([^\"]+)\".{20,350}echo=\"([^\"]+)').findall(link.replace('\n','').replace('\r',''))
			if match:
				for url2,name2,img2 in match:
					url2 = re.sub('^\.', "https://www."+RC, url2 )
		...
		for name2,url2,brp in match:
			...
			if urlm:
				if "http" not in urlm[0]:
					urlm[0] = "https://www."+ RC + urlm[0]
			if len(urlm) > 1:
				if "http" not in urlm[1]:
					urlm[1] = "https://www."+ RC  + urlm[1]
...
def Busca(): # 160
	...
	try:
		...
		for x in range(0, 10):
			l +=1
			link = common.OpenURL(proxy+"https://www." + RC +"search.php?keywords="+d+"&page="+str(l))
	...
	i=0
	try:
		AddDir("[COLOR cyan][B]MMfilmes[/B][/COLOR]", "" , 0 ,"", isFolder=False)
...
def PlayTVCB(): #103
	...
	#except urllib2.URLError, e:
	#	xbmcgui.Dialog().ok('Play XD', "Servidor offline, tente novamente em alguns minutos")
# ----------------- Fim TV Cubeplay
# ----------------- REDECANAIS TV
def Acento(x):
		...
		for x in range(0, 5):
			...
			if m:
				for name2,b,url2 in m:
					name2 = name2.replace("&#8211;","-").replace("&#038;","&").replace("&#8217;","\'")
					if not url2 in ms:
						AddDir(name2+ " [COLOR yellow]"+res[i]+"[/COLOR] [COLOR green]"+dubleg[i]+"[/COLOR]", url2, 181, jpg[i], jpg[i],isFolder=True,IsPlayable=False)
					i+=1
			i=0
	except:
		pass
def ListFilmeMM(pagina2): #180
	...
	i=0
	if int(pagina) > 0:
		AddDir("[COLOR lime][B]<< Pagina Anterior ["+ str( int(pagina) ) +"[/B]][/COLOR]", pagina , 120 ,"http://icons.iconarchive.com/icons/iconsmind/outline/256/Previous-icon.png", isFolder=False, background=pagina2)
	try:
		links = common.OpenURL("http://www.mmfilmes.tv/series/")
		ms = re.compile('href\=\"(.+www.mmfilmes.tv.+)\" rel\=\"bookmark\"').findall(links)
		for x in range(0, 5):
			...
			if m:
				for name2,b,url2 in m:
					name2 = name2.replace("&#8211;","-").replace("&#038;","&").replace("&#8217;","\'")
					if not url2 in ms:
						AddDir(name2+ " [B][COLOR yellow]"+res[i]+"[/COLOR][/B] [B][COLOR cyan]"+dubleg[i]+"[/COLOR][/B]", url2, 181, jpg[i], jpg[i],isFolder=True,IsPlayable=False)
					i+=1
					p+=1
			i=0
			if p >= 50:
...
def PlayLinkMM(): #182
	...
	if m:
		m[0] = "http://player.mrhd.tv" + m[0] if not "http" in m[0] else m[0]
		link2 = common.OpenURL(re.sub('(\/.{1,25}\/).{1,10}\/', r'\1', m[0]),headers={'referer': "http://player.mrhd.tv"}).replace("file","\nfile")
		...
		if d!= -1:
			...
			if legenda:
				...
				if not "http" in legenda:
					legenda = "http://player.mrhd.tv/" + legenda
...
def ListEpiMM(x): #192
	...
	for e,url2 in epi:
		url2 = "http://player.mrhd.tv" + url2 if not "http" in url2 else url2
		if p == int(e) :
			r+=1
...
def PlaySMM(): #194
	...
	if cdn:
		...
		link2 = common.OpenURL( re.sub('(\/.{1,25}\/).{1,10}\/', r'\1', url) ,headers={'referer': "http://player.mrhd.tv"}).replace('"',"'")
